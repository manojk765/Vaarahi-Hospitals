        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            ...
            <div className="flex gap-4">
              <button className="bg-sky-600 text-white px-6 py-3 rounded-lg hover:bg-sky-700 transition-all">
                Schedule Evaluation
              </button>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p>Mon-Fri: 8am-6pm</p>
                <p>Sat: 9am-1pm (by appointment)</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p>Email: childdevelopment@example.com</p>
              </div>
            </div>
          </div>
        </div>
